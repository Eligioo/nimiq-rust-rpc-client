...
impl Client {
	...
	pub fn consensus(&self) -> Result<String, serde_json::Error>{
	...
	pub fn create_account(&self) -> Result<primitives::Wallet, serde_json::Error>{
	...
	pub fn create_raw_transaction(&self, raw_transaction: &primitives::OutgoingTransaction) -> Result<String, serde_json::Error>{
	...
	pub fn get_account(&self, id: &str) -> Result<primitives::Account, serde_json::Error>{
	...
	pub fn get_block_by_hash(&self, block_hash: &str, full_transactions: bool) -> Result<primitives::Block, serde_json::Error>{
	...
	pub fn get_block_template(&self) -> Result<primitives::FullBlock, serde_json::Error>{
	...
	pub fn get_transaction_by_hash(&self, transaction_hash: &str) -> Result<primitives::Transaction, serde_json::Error>{
	...
	pub fn get_transaction_receipt(&self, transaction_hash: &str) -> Result<primitives::TransactionReceipt, serde_json::Error>{
	...
	pub fn get_work(&self) -> Result<primitives::GetWork, serde_json::Error>{
	...
	pub fn log(&self, tag: &str, level: &str) -> Result<bool, serde_json::Error>{
	...
	pub fn mempool_content(&self) -> Result<Vec<String>, serde_json::Error>{
	...
	pub fn miner_address(&self) -> Result<String, serde_json::Error>{
	...
	pub fn miner_threads(&self) -> Result<u8, serde_json::Error>{
	...
	pub fn min_fee_per_byte(&self) -> Result<u32, serde_json::Error>{
	...
	pub fn min_fee_per_byte_with_update(&self, fee: u32) -> Result<u32, serde_json::Error>{
	...
	pub fn mining(&self) -> Result<bool, serde_json::Error>{
	...
	pub fn peer_count(&self) -> Result<i8, serde_json::Error>{
	...
	pub fn peer_list(&self) -> Result<Vec<primitives::PeerList>, serde_json::Error>{
	...
	pub fn peer_state(&self, peer_address: &str) -> Result<primitives::PeerState, serde_json::Error>{
	...
	pub fn peer_state_with_update(&self, peer_address: &str, set: &str) -> Result<primitives::PeerState, serde_json::Error>{
	...
	pub fn pool_confirmed_balance(&self) -> Result<u64, serde_json::Error>{
	...
	pub fn pool_connection_state(&self) -> Result<u8, serde_json::Error>{
	...
	pub fn send_raw_transaction(&self, transaction_hash: &str) -> Result<String, serde_json::Error>{
	...
	pub fn send_transaction(&self, transaction: &primitives::OutgoingTransaction) -> Result<String, serde_json::Error>{
	...
	pub fn submit_block(&self, full_block: &str) -> Result<(), serde_json::Error>{
	...
	pub fn syncing(&self) -> Result<primitives::Syncing, serde_json::Error>{
